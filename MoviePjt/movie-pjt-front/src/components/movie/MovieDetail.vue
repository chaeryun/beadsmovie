    ...
    <v-row>
      ...
      <v-col cols="8">
        <v-card flat>
          ...
          <h3 class="ml-4 mb-2 mt-3"> Overview : <br />CIA 요원이자 전 연인(크리스 파인, 탠디 뉴턴)이 구출 임무를 실패하고 몇 년이 지난 뒤 재회하고,
            <br /> 업무와 개인적인 감정을 구분하지 못한다. 국제 스파이 행위, 도덕적 딜레마, 
            <br/> 그리고 치명적인 배신을 다룬 눈을 뗄 수 없는 이야기다.</h3>
      ...
      <v-col class="mb-2 mt-10">
          ...
          <iframe class="video-iframe" width="90%" height="400" :src="`https://www.youtube-nocookie.com/embed/DfQx5kfERwE`" frameborder="0" allowfullscreen></iframe>
        </div>
      </v-col>
      <v-col cols="7">
